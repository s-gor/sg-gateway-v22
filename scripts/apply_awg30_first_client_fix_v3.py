...
warning_pattern = (
    r"    \{% if awg3_runtime\.known and not awg3_runtime\.ready %\}\n"
    r"    <div class=\"cv2-filter-footer\" data-awg3-runtime-warning>\n"
    r".*?\n"
    r"    </div>\n"
    r"    \{% endif %\}\n"
)
...
old_selector = "\n".join(
    [
        "          if [[ -f vendor/cores/amneziawg-tools-3.1.20260812.tar.gz ]]; then",
