...
- **Подписки для роутеров.** Для каждого устройства доступны `OpenWrt · HomeProxy SUB`, отдельный VLESS-фид `Keenetic · XKeen SUB` и универсальный Router JSON для внешних интеграторов. Старые SUB-ссылки продолжают работать.
